...
## Why TribanFT?
**TribanFT is a multi-layer security platform** that detects sophisticated attacks across network, enriches threat data with actionable intelligence, and unifies CrowdSec, NFTables, and Fail2Ban into a single detection engine.
