...
class BruteForceDetectorEngine:
    ...
    def __init__(self):
        ...
        try:
            ...
            self.detectors = [
                PreloginDetector(self.whitelist_manager),
                PortScanDetector(self.whitelist_manager),
                FailedLoginDetector(self.whitelist_manager),
                CrowdSecDetector(self.whitelist_manager)
            ]
